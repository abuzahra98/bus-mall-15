...
function addSelectedItemToCart( ) {
  ...
  let quantityLocation = document.getElementById( 'quantity' );
  let quantity = quantityLocation.value;
...
function updateCounter( ) {
  let numberOfItems = cart.items.length;
  let itemLocation = document.getElementById( 'itemCount' );
